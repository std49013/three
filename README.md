...
<head>
    ...
    <style>
        /* =========================================
           1. CSS Variables & Theme (Light/Dark)
        ========================================= */
        :root {
            /* Light Theme Colors */
        ...
        [data-theme="dark"] {
            ...
            --glass-text: #fff;
            --card-hover-bg: rgba(30, 45, 70, 0.8);
        }
        ...
        * {
            ...
            font-family: 'Sarabun', 'Prompt', sans-serif; /* รองรับฟอนต์ไทย */
        ...
        section.active {
            display: block; /* แสดงเฉพาะหน้าที่มี class active */
        }
        ...
        @media (max-width: 768px) {
            nav ul { display: none; /* ซ่อนเมนูในมือถือ (เพื่อความกะทัดรัดของโค้ด สามารถต่อยอด Hamburger menu ได้) */ }
...
<body>
    ...
    <script>
        ...
        // คะแนนที่ได้ 1-5 จะถูกนำไปคูณกับน้ำหนัก เพื่อหาเปอร์เซ็นต์ความเหมาะสม
        const quizQuestions = [
        ...
        function processQuiz() {
            ...
            // เรียงจากมากไปน้อย (Sort Descending)
        ...
        function renderResultDashboard(top3) {
            ...
            // Trigger Animation สำหรับ Progress Bar
            setTimeout(() => {
        ...
        function updateCompareSelects() {
            ...
            // เลือกอันที่ 2 เป็นค่าเริ่มต้นที่แตกต่าง
        ...
        function addProgramMock() {
            ...
            // เพิ่มข้อมูลลง Array (จำลองการบันทึก)
            programsData.push({
                id: 'new_' + Date.now(),
                name: name,
                level: 'ทั่วไป',
            ...
            // Re-render UI ที่เกี่ยวข้องกับข้อมูล
            renderPrograms();
        }
